...
require_once(dirname(__FILE__) . '/spell/src/common.php');
...
$dir = dirname(__FILE__) . '/spell/dicts';
...
$word_one = iconv('UTF-8', 'cp1251', 'большие');
$word_two = iconv('UTF-8', 'cp1251', 'маленькие');
